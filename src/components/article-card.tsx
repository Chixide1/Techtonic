      ...
      <article className="flex flex-col flex-1 md:flex-row p-5 gap-8 max-w-full">
        ...
        <div className="flex flex-col gap-4 flex-grow justify-between w-auto">
          <div className="flex w-full gap-6">
            <div className="text-sm font-semibold flex w-full max-w-[15ch]">
            ...
            <span className="ml-auto text-gray-600 text-sm max-w-[15ch] whitespace-nowrap overflow-hidden text-ellipsis dark:text-gray-400">{formattedArticleCreated}</span>
          </div>
          <h5 className="text-lg font-semibold md:max-w-xl md:text-balance md:w-8/12">{article.title}</h5>
