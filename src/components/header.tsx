...
export function Header() {
  return (
    <header className='flex gap-12 justify-between items-center w-full border-gray-200 dark:border-0 dark:bg-background/95 backdrop-blur-sm p-3 px-8 max-w-full sticky top-0 z-30'>
